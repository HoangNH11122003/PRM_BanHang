...
// dbClient.getAppDatabase().brandDao().getAllBrands();
// List<BrandProductsDto> brandDtos = new ArrayList<>();
// for (Brand brand : brands) {
// int productCount =
// dbClient.getAppDatabase().brandDao().getProductCountByBrand(brand.getBrandId());
...
// dbClient.getExecutorService().execute(() -> {
// final Brand brand =
// dbClient.getAppDatabase().brandDao().getBrandById(brandId);
...
// });
// } catch (Exception e) {
// dbClient.getMainHandler().post(() -> callback.onError("Error getting brand
// count: " + e.getMessage()));
// }
...
// dbClient.getExecutorService().execute(() ->
// dbClient.getAppDatabase().brandDao().insert(brand));
// }

// public void updateBrand(Brand brand) {
// dbClient.getExecutorService().execute(() ->
// dbClient.getAppDatabase().brandDao().update(brand));
// }
...
// "Cannot delete brand '" + brand.getName() + "'. Products are still associated
// with it.",
...
// System.out.println("Simulated exception caught: NullPointerException (not
// real)");
// }
